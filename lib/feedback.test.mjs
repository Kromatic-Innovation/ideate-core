...
test("panelistToFeedback is a back-compat alias of exampleAdapterFromPanelist (ideate-core#56/#48)", () => {
  // The 0.1.0-published export name must keep working for one release after the
  // ideate-core#48 rename, and must produce byte-identical results to the renamed function.
