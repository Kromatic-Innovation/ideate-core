...
/**
 * @deprecated since 0.2.0 — renamed to {@link exampleAdapterFromPanelist} in ideate-core#48
 * to signal it is a worked EXAMPLE adapter, not a required part of the API. This
 * alias preserves the export name shipped in `ideate-core@0.1.0` so a `0.1.0`
 * consumer's `import { panelistToFeedback } from "ideate-core/feedback"` keeps
 * working. **Removal: `0.4.0`** (the next minor; pre-1.0 minors may drop a
 * deprecated export). Import `exampleAdapterFromPanelist` instead.
 */
