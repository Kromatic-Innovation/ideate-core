 ...
 *                                        the no-throw robustness contract. meta also
 *                                        reports agentsAttempted / agentsFailed.
...
export async function ideateCore(input = {}, deps = {}) {
  ...
  const onAgentError = typeof deps.onAgentError === "function" ? deps.onAgentError : null;
