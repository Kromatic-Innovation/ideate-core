...
test("regeneration sends the originating agent's numeric temperature resolved by agentId, never a label (ideate-core#92, ideate-core#166)", async () => {
  const seen = [];
  ...
  // Candidates carry no `temperature` field of their own (ideate-core#166) —
  // the regen call must resolve the agent's numeric temperature by agentId.
  const pool = [
    {
      id: "pragmatist-r1-1",
      text: "orig",
